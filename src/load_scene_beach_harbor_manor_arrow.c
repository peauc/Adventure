...
{
  if ((data->tab[4].back =
       bunny_load_pixelarray("sprites/beach_back.png")) == NULL
      || (data->tab[4].back =
	  resize_picture(data->tab[4].back, 2048, 576)) == NULL
      || (data->tab[4].front =
	  bunny_load_pixelarray("sprites/beach_front.png")) == NULL
      || (data->tab[4].front =
...
{
  if ((data->tab[9].back =
       bunny_load_pixelarray("sprites/manor_in_back.png")) == NULL
      || (data->tab[9].back =
	  resize_picture(data->tab[9].back, 2048, 576)) == NULL
      || (data->tab[9].front =
	  bunny_load_pixelarray("sprites/manor_in_front.png")) == NULL
      || (data->tab[9].front
	  = resize_picture(data->tab[9].front, 2048, 576)) == NULL
      || (data->tab[9].name = my_strdup("manor_in")) == NULL
      || (data->tab[8].front
	  = bunny_load_pixelarray("sprites/manor.png")) == NULL
      || (data->tab[8].front
...
{
  if ((data->tab[1].back =
       bunny_load_pixelarray("sprites/boat_back.png")) == NULL
      || (data->tab[1].back =
	  resize_picture(data->tab[1].back, 1024, 576)) == NULL
      || (data->tab[1].front =
	  bunny_load_pixelarray("sprites/boat_front.png")) == NULL
      || (data->tab[1].front =
	  resize_picture(data->tab[1].front, 1024, 576)) == NULL
      || (data->tab[1].name = my_strdup("boat")) == NULL
      || (data->tab[0].back =
	  bunny_load_pixelarray("sprites/harbor_back.png")) == NULL
      || (data->tab[0].back =
	  resize_picture(data->tab[0].back, 2048, 576)) == NULL
      || (data->tab[0].front =
	  bunny_load_pixelarray("sprites/harbor_front.png")) == NULL
      || (data->tab[0].front =
...
int	load_arrow(t_data *data)
{
  if ((data->tab[10].front =
       bunny_load_pixelarray("sprites/arrow_down.png")) == NULL
      || (data->tab[10].name = my_strdup("down")) == NULL
      || (data->tab[11].front =
	  bunny_load_pixelarray("sprites/arrow_up.png")) == NULL
      || (data->tab[11].name = my_strdup("up")) == NULL
      || (data->tab[12].front =
	  bunny_load_pixelarray("sprites/arrow_left.png")) == NULL
      || (data->tab[12].name = my_strdup("left")) == NULL
      || (data->tab[13].front =
	  bunny_load_pixelarray("sprites/arrow_right.png")) == NULL
